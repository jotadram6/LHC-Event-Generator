...
void help(){
  ...
  cout << "For generate and compile a process type 'generate state1 > state2' with spaces and without quotes\n";
  cout << "For launch a process type 'launch folder_name' without quotes\n";
  cout << "For quit the program type quit\n";
}
